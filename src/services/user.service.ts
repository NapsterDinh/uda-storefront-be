...
export class UserService {
  ...
  async createUser(newUserPayload: PayloadCreateUser) {
    try {
      ...
      const result = await this.getUser(newUser.username);
  ...
  async updateUser(id: number, newUpdatedUserData: PayloadUpdateUser) {
    try {
